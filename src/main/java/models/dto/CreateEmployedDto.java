...
public class CreateEmployedDto {
    private String id;
    private String emri;
    ...
    public CreateEmployedDto(String id, String emri, String mbiemri, String gjinia, String titulli, String drejtimi, String profesioni, String kompania) {
        this.id = id;
        this.emri = emri;
